//video recuhttps://youtu.be/yOPM-PP4AGg
...
void mousePressed() {
  ...
  //botones circulares
    ...
    pantalla=8;
  }  else if ( pantalla==7 && dentroDecircB(300, 550, 50)) {
    pantalla=9;
  }  else if ( pantalla==7 && dentroDecircB(450, 550, 50)) {
    pantalla=10;
  }
  //fin
  ...
  ///tres botones///
   else if ( pantalla==13 && dentroDecircB(150, 550, 50)) {
    pantalla=14;
  }  else if ( pantalla==13 && dentroDecircB(300, 550, 50)) {
    pantalla=15;
  }  else if ( pantalla==13 && dentroDecircB(450, 550, 50)) {
    pantalla=16;
  } 
  ///terminan los 3 botones///
